...
export const celebrityPosts: BlogPost[] = [
  ...
  },
  {
    ...
    cta,
    relatedSlugs: ["lim-young-woong-mbti", "idol-mbti-list-warning", "mbti-result-changes"],
    sources: [
  ...
  },
  {
    ...
    cta,
    relatedSlugs: ["yoo-jae-suk-mbti", "idol-mbti-list-warning", "mbti-e-vs-i"],
    sources: [
  ...
  {
    slug: "idol-mbti-list-warning",
    category: "트렌드",
    title: "아이돌 MBTI 목록은 왜 사이트마다 다를까",
    description:
      "2026년 9월 신인 아이돌그룹 브랜드평판 1위 리센느를 예로, 떠도는 아이돌 MBTI 목록이 서로 어긋나는 이유와 무엇까지가 확인된 사실인지 정리했습니다.",
    keywords: ["아이돌 MBTI", "리센느 MBTI", "아이돌 MBTI 목록", "신인 아이돌 브랜드평판", "케이팝 MBTI"],
    readTime: "약 6분",
    publishedAt: septReputationAt,
    updatedAt: septReputationAt,
    intro: [
      "아이돌 MBTI 목록이 사이트마다 다른 가장 큰 이유는, 상당수가 소속사 공식 프로필이 아니라 팬 투표와 추측에서 나온 값이기 때문입니다. 같은 멤버가 한 곳에서는 ENFP, 다른 곳에서는 INFP 로 적히는 일이 흔합니다.",
      "2026년 9월 신인 아이돌그룹 브랜드평판 1위는 리센느였습니다. 한국기업평판연구소가 2026년 8월 1일부터 9월 1일까지 모은 빅데이터 1,973만 건을 분석한 결과입니다.",
    ],
    sections: [
      {
        heading: "2026년 9월 신인 아이돌그룹 평판 순위",
        paragraphs: [
          "1위 리센느, 2위 코르티스, 3위 키키, 4위 하츠투하츠, 5위 튜이드, 6위 아일릿, 7위 투어스, 8위 베이비몬스터, 9위 캣츠아이, 10위 미야오 순으로 분석됐습니다.",
          "1위 리센느의 링크분석에서는 ‘응원하다, 기부하다, 광고하다’가, 키워드분석에서는 ‘러브어택, 프리티걸, 안원잘부’가 높게 나왔고 긍정비율은 94.30% 였습니다.",
        ],
      },
      {
        heading: "목록이 어긋나는 세 가지 이유",
        paragraphs: [
          "첫째, 출처가 다릅니다. 소속사 프로필과 팬 투표 사이트, 커뮤니티 정리글이 뒤섞여 인용되는데 이 셋은 신뢰도가 전혀 다릅니다.",
          "둘째, 시점이 다릅니다. 데뷔 전 프로필에 적힌 유형과 몇 년 뒤 다시 검사한 결과가 다른 경우가 많고, 목록은 대개 갱신되지 않습니다.",
          "셋째, 자기보고식 검사 자체가 상황을 탑니다. 경계에 가까운 지표는 컨디션과 답할 때 떠올린 장면에 따라 뒤집힙니다.",
        ],
      },
      {
        heading: "그래서 이 글에는 멤버별 유형을 적지 않았습니다",
        paragraphs: [
          "리센느 멤버 개개인의 MBTI 는 공식 프로필에서 확인되는 자료를 찾지 못했습니다. 검색에 나오는 수치는 이용자 투표 기반 사이트의 집계라 본인의 검사 결과가 아닙니다.",
          "확인되지 않은 값을 표로 옮기면 그 표가 또 다른 목록의 출처가 됩니다. 어긋난 목록이 늘어나는 방식이 정확히 이것이라, 비워 두는 쪽을 택했습니다.",
        ],
      },
      {
        heading: "확인하려면 어디를 봐야 하나요",
        paragraphs: [
          "소속사가 배포한 공식 프로필, 팬카페 공지, 방송에서 본인이 직접 말한 장면 — 이 셋만 출처로 씁니다. 날짜를 함께 적어 두면 나중에 바뀌었을 때 구분할 수 있습니다.",
          "‘본인이 밝힌 적 없음’ 도 정확한 정보입니다. 네 글자를 채우는 것보다 낫습니다.",
        ],
      },
    ],
    cta,
