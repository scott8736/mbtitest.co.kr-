...
const seeds: TestSeed[] = [
  ...
  {
    slug:"undercover-chef",title:"언더커버 셰프 심리테스트",shortTitle:"언더커버 셰프",eyebrow:"UNDERCOVER CHEF",description:"이름과 경력을 내려놓고 낯선 주방의 막내가 된다면 나는 어떻게 인정받을까요? tvN 공식 프로그램의 도전 콘셉트를 참고해 독자적으로 만든 비공식 팬 심리테스트입니다.",category:"성격",icon:"♨",color:"#b94732",keywords:["언더커버 셰프 심리테스트","언더커버 셰프 테스트","셰프 유형 테스트","주방 성격 테스트"],
    results:[
      {key:"observer",name:"미장플라스 관찰형",tagline:"칼을 잡기 전에 주방의 흐름부터 읽는 조용한 전략가",summary:"낯선 주방에서도 재료의 위치, 선배의 동선, 손님의 취향을 빠르게 관찰한 뒤 정확한 타이밍에 실력을 보여줍니다.",color:"#55786f",traits:["관찰력","정확성","적응"],signals:["처음 간 곳에서는 바로 나서기보다 흐름부터 살핀다","새로운 일을 맡으면 기존 방식과 규칙을 먼저 익힌다","한 번 파악한 순서와 사람의 취향을 잘 기억한다"]},
      {key:"fire",name:"화구 돌파형",tagline:"주문이 몰릴수록 집중력이 뜨거워지는 현장 승부사",summary:"예상치 못한 변수와 시간 압박 속에서 오히려 감각이 살아나며, 직접 움직여 문제를 해결하고 기회를 잡습니다.",color:"#d76543",traits:["순발력","담력","실행"],signals:["급한 상황에서는 고민보다 몸이 먼저 움직인다","실수해도 바로 다음 방법을 시도하는 편이다","시간이 촉박할수록 집중력이 더 높아진다"]},
      {key:"creator",name:"신메뉴 혁신형",tagline:"본토의 맛을 존중하면서 나만의 한 접시를 만드는 창작자",summary:"익숙한 재료와 전통을 새롭게 연결해 사람들의 기억에 남는 아이디어를 만들고, 마지막 순간까지 더 나은 조합을 탐색합니다.",color:"#8c62a5",traits:["창의성","호기심","도전"],signals:["기존 방식을 배우면서도 더 나은 조합을 떠올린다","새로운 재료나 도구를 보면 직접 시험해 보고 싶다","정답이 없는 과제에서 아이디어가 더 잘 나온다"]},
      {key:"team",name:"주방 팀워크형",tagline:"실력보다 먼저 신뢰를 쌓아 모두의 손을 맞추는 조율가",summary:"혼자 돋보이기보다 선배와 동료의 필요를 빠르게 알아차리고, 작은 일도 책임 있게 해내며 팀의 인정을 얻습니다.",color:"#5374a1",traits:["협업","신뢰","배려"],signals:["새로운 팀에서는 내가 도울 일을 먼저 찾는다","칭찬보다 함께 일하기 편하다는 말을 들을 때 뿌듯하다","문제가 생기면 사람들의 역할을 조율하는 편이다"]},
    ],
  },
];
